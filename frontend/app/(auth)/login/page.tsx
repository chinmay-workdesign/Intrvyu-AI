    ...
    <div className="min-h-screen bg-base grid-pattern relative flex items-center justify-center px-4 text-txt-primary">
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h2 className="text-xl font-display font-semibold text-txt-primary">Welcome back</h2>
          <p className="text-xs text-txt-secondary leading-relaxed">Sign in to resume mock interview practice</p>
        </div>
        ...
        <div className="flat-card rounded-xl bg-surface border-hairline p-6 md:p-8 shadow-2xl space-y-6">
          ...
          <div className="text-center text-xs font-sans border-t border-hairline pt-4">
            <span className="text-txt-secondary">Don&apos;t have an account? </span>
            <Link href="/signup" className="text-accent hover:underline font-semibold transition-colors">
              Sign up
            </Link>
          </div>
        </div>
